...
class Window(tk.Toplevel):
    ...
    def extract_data(self):
        ...
        # On prépare une seule requête pour tout récupérer en une fois
        tab = []
        try:
            query = """
            ...
            # On ajoute les résultats au tableau
            for row in result:
        ...
        self.timelabel.configure(text="Le calcul a pris " + str(round(end - start, 3)) + " secondes et exécuté " + str(nbquery) + " requête(s).")